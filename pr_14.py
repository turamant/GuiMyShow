...
def the_thread(count):
    ...
    while True:
        time.sleep(2)
        popup(f'Hello, this is the thread #{count}', 'My counter value', i, text_color='white', background_color='red',
              non_blocking=True, keep_on_top=True, location=(1000 - 200 * count, 400))
        i += 1
